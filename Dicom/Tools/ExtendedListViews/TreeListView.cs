...
namespace SynapticEffect.Forms
{
	...
	/// controls.
	/// </summary>
	public class TreeListView : SynapticEffect.Forms.ContainerListView
	{
		#region Events
		...
		public TreeListView(): base()
		{
			...
			Assembly myAssembly = Assembly.GetAssembly(Type.GetType("SynapticEffect.Forms.TreeListView"));
			Stream bitmapStream1 = myAssembly.GetManifestResourceStream("SynapticEffect.Forms.Resources.tv_minus.bmp");
			bmpMinus = new Bitmap(bitmapStream1);

			Stream bitmapStream2 = myAssembly.GetManifestResourceStream("SynapticEffect.Forms.Resources.tv_plus.bmp");
			...
			if (node.IsVisible)
			{
					...
					&& (r.Top+itemheight*totalRend+eb/4-vscrollBar.Value < r.Top+r.Height)))
				{
					...
					else
					{
						...
						{
							smallImageList.Draw(g, r.Left+lb+eb+2-hscrollBar.Value, r.Top+hb+itemheight*totalRend+eb/4-2-vscrollBar.Value + 3, 16, 16, node.ImageIndex);
							ib = 18;
						}
					}
					...
					{						
						if (showrootlines && level == 0)
						{
							if (index == 0)
							{
								g.DrawLine(linePen, r.Left + eb / 2 - hscrollBar.Value, r.Top + eb / 2 + hb - vscrollBar.Value + 4, r.Left + eb - hscrollBar.Value, r.Top + eb / 2 + hb - vscrollBar.Value + 4);
								g.DrawLine(linePen, r.Left + eb / 2 - hscrollBar.Value, r.Top + eb / 2 + hb - vscrollBar.Value + 4, r.Left + eb / 2 - hscrollBar.Value, r.Top + eb + hb - vscrollBar.Value + 4);
							}
							else if (index == count-1)
							{
								g.DrawLine(linePen, r.Left + eb / 2 - hscrollBar.Value, r.Top + eb / 2 + hb + itemheight * (totalRend) - vscrollBar.Value + 4, r.Left + eb - hscrollBar.Value, r.Top + eb / 2 + hb + itemheight * (totalRend) - vscrollBar.Value + 4);
								g.DrawLine(linePen, r.Left + eb / 2 - hscrollBar.Value, r.Top + hb + itemheight * (totalRend) - vscrollBar.Value + 4, r.Left + eb / 2 - hscrollBar.Value, r.Top + eb / 2 + hb + itemheight * (totalRend) - vscrollBar.Value + 4);
							}
							else
							{
								g.DrawLine(linePen, r.Left + eb / 2 - hscrollBar.Value, r.Top + eb + hb + itemheight * (totalRend) - eb / 2 - vscrollBar.Value + 4, r.Left + eb - hscrollBar.Value, r.Top + eb + hb + itemheight * (totalRend) - eb / 2 - vscrollBar.Value + 4);
								g.DrawLine(linePen, r.Left + eb / 2 - hscrollBar.Value, r.Top + eb + hb + itemheight * (totalRend - 1) - vscrollBar.Value + 4, r.Left + eb / 2 - hscrollBar.Value, r.Top + eb + hb + itemheight * (totalRend) - vscrollBar.Value + 4);
							}

							if (childCount > 0)
								g.DrawLine(linePen, r.Left + eb / 2 - hscrollBar.Value, r.Top + hb + itemheight * (totalRend - childCount) - vscrollBar.Value + 4, r.Left + eb / 2 - hscrollBar.Value, r.Top + hb + itemheight * (totalRend) - vscrollBar.Value + 4);
						}
					}
					...
					{						
						if (showlines && level > 0)
						{
							if (index == count-1)
							{
								g.DrawLine(linePen, r.Left + lb + eb / 2 - hscrollBar.Value, r.Top + eb / 2 + hb + itemheight * (totalRend) - vscrollBar.Value + 4, r.Left + lb + eb - hscrollBar.Value, r.Top + eb / 2 + hb + itemheight * (totalRend) - vscrollBar.Value + 4);
								g.DrawLine(linePen, r.Left + lb + eb / 2 - hscrollBar.Value, r.Top + hb + itemheight * (totalRend) - vscrollBar.Value + 4, r.Left + lb + eb / 2 - hscrollBar.Value, r.Top + eb / 2 + hb + itemheight * (totalRend) - vscrollBar.Value + 4);
							}
							else
							{
								g.DrawLine(linePen, r.Left + lb + eb / 2 - hscrollBar.Value, r.Top + eb / 2 + hb + itemheight * (totalRend) - vscrollBar.Value + 4, r.Left + lb + eb - hscrollBar.Value, r.Top + eb / 2 + hb + itemheight * (totalRend) - vscrollBar.Value + 4);
								g.DrawLine(linePen, r.Left + lb + eb / 2 - hscrollBar.Value, r.Top + hb + itemheight * (totalRend) - vscrollBar.Value + 4, r.Left + lb + eb / 2 - hscrollBar.Value, r.Top + eb + hb + itemheight * (totalRend) - vscrollBar.Value + 4);
							}

							if (childCount > 0)
								g.DrawLine(linePen, r.Left + lb + eb / 2 - hscrollBar.Value, r.Top + hb + itemheight * (totalRend - childCount) - vscrollBar.Value + 4, r.Left + lb + eb / 2 - hscrollBar.Value, r.Top + hb + itemheight * (totalRend) - vscrollBar.Value + 4);
						}
					}
					...
					if (r.Left+lb+eb/2+5-hscrollBar.Value > r.Left)
					{
						if (showplusminus && (node.GetNodeCount(false) > 0 || alwaysShowPM))
						{
							if (index == 0 && level == 0)
							{
								RenderPlus(g, r.Left+lb+eb/2-4-hscrollBar.Value, r.Top+hb+eb/2-vscrollBar.Value, 8, 8, node);
							}
							else if (index == count-1)
							{

								RenderPlus(g, r.Left+lb+eb/2-4-hscrollBar.Value, r.Top+hb+itemheight*totalRend+eb/2-vscrollBar.Value, 8, 8, node);
							}
							else
							{
								RenderPlus(g, r.Left+lb+eb/2-4-hscrollBar.Value, r.Top+hb+itemheight*totalRend+eb/2-vscrollBar.Value, 8, 8, node);
