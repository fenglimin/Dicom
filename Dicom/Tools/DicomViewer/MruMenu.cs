...
namespace DicomViewer
{
    public class MruMenu
    {
        ...
        {
            Init(_recentFileMenuItem, _clickedHandler, null, false, 9);
        }
        ...
        {
            Init(_recentFileMenuItem, _clickedHandler, _registryKeyName, true, 9);
        }
        ...
        {
            Init(_recentFileMenuItem, _clickedHandler, _registryKeyName, loadFromRegistry, 9);
        }
...
String fileNameCopy = (String)menuItem.Filename.Clone();
    ...
    public class MruMenuInline : MruMenu 
    {
        ...
        public MruMenuInline(MenuItem _recentFileMenuItem, ClickedHandler _clickedHandler)
        {
            ...
            base.Init(_recentFileMenuItem, _clickedHandler, null, false, 9);
        }
        ...
        public MruMenuInline(MenuItem _recentFileMenuItem, ClickedHandler _clickedHandler, String _registryKeyName)
        {
            maxShortenPathLength = 128;
            firstMenuItem = _recentFileMenuItem;
            base.Init(_recentFileMenuItem, _clickedHandler, _registryKeyName, true, 9);
        }
        ...
        public MruMenuInline(MenuItem _recentFileMenuItem, ClickedHandler _clickedHandler, String _registryKeyName, bool loadFromRegistry)
        {
            maxShortenPathLength = 128;
            firstMenuItem = _recentFileMenuItem;
            base.Init(_recentFileMenuItem, _clickedHandler, _registryKeyName,loadFromRegistry, 9);
        }
